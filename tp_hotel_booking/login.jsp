		...
		<div class="container">
			<div class="row">
				<div class="page-head-content">
					<h1 class="page-title">우리 사이트에 오신 것을 환영합니다.</h1>
				</div>
			</div>
		</div>
	</div>
			...
			<div
				...
				<div class="box-for overflow">
					<div class="col-md-12 col-xs-12 login-blocks">
						...
						<form action="./LoginAction.do" method="post">
							<div class="form-group">
								<label for="email">Email</label> <input type="text"
									class="form-control" name="u_email" id="u_email" />
							</div>
							<div class="form-group">
								<label for="password">Password</label> <input type="password"
									class="form-control" name="u_pwd" id="u_pwd" />
							</div>
						...
						<br />
						<div class="form-group">
							<a href="./register.do">아이디가 없습니까? 회원가입하세요</a> <br /> <a
								href="./password.do">비밀번호를 모르십니까?</a>
						</div>

						<h2>Social login :</h2>

						<p>
							<a class="login-social" href="#"><i
								class="fa fa-facebook"></i>&nbsp;Facebook</a> <a
								class="login-social" href="#"><i
								class="fa fa-google-plus"></i>&nbsp;Gmail</a> <a
								class="login-social" href="#"><i
